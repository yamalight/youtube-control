...
export default ({ channel }) => {
  ...
  const wrapperClasses = useHorizontalLayout
    ? 'flex flex-col shadow border rounded border-gray-800 bg-gray-900 lg:m-2 min-w-3 max-h-view overflow-auto'
    : 'flex flex-col shadow border rounded border-gray-800 bg-gray-900 lg:m-2 w-full sm:w-1/2 md:w-1/2 lg:w-1/4 max-h-view overflow-auto';

  return (
    <div className={wrapperClasses}>
      <div className="flex flex-wrap shadow border-b border-gray-800 bg-gray-900 h-20">
        <div className="flex w-full h-20">
          ...
          >
            ...
            {hover && (
              <a
                href="#"
                className="bg-gray-900 hover:bg-gray-800 text-gray-100 py-2 px-2 inline-flex items-center mr-4"
                onClick={e => {
                  e.preventDefault();
